...
let add#2/2 (x#3 : Int, y#4 : Int) : Int = let π#5 : Int = ADD(#3, #4) in ret #5

let inc#6/0 : Int → Int = let app#7 : Int → Int = #2ᵖ(1) in ret #7

let applyTwice#8/2 (f#9 : α → α, x#10 : α) : α =
  let app#11 : α = #9(#10)
  let app#12 : α = #9(#11) in ret #12
...
let main#13/0 : Int × Int × Int =
  ...
  let p#19 : Int × Int × Int = ⟨#15, #18⟩ in ret #19
;; == Runtime ==
(load "runtime.lisp")
