...
let rec eval#2/1 (?x₀#3 : Expr Int) : Int =
  case #3 of
    Add⟦f#4 : Expr Int, f#5 : Expr Int⟧ =>
      let app#6 : Int = #2(#4)
      let app#7 : Int = #2(#5)
      let π#8 : Int = ADD(#6, #7) in ret #8;
    Mul⟦f#9 : Expr Int, f#10 : Expr Int⟧ =>
      let app#11 : Int = #2(#9)
      let app#12 : Int = #2(#10)
      let π#13 : Int = MUL(#11, #12) in ret #13;
...
let main#15/0 : Int =
  ...
  let con#20 : Expr Int = Mul⟦#16, #19⟧
  let app#21 : Int = #2(#20) in ret #21
;; == Runtime ==
(load "runtime.lisp")
