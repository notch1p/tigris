...
or termination checking is nonexistent in \Tigrisd.
...
such as \rref{C-switch-mode, I-App, C-WHNF}. We define the equality as follows:
...
Where the judgment $\Gamma\vdash\mathbf{WHNF}\ tm\leadsto nf$ reads: under context $\Gamma$, $tm$ reduces to $nf$, which is
...
cannot be reduced further. Therefore, it belongs in WHNF. For example, the term
