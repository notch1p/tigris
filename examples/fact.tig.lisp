                ...
                (let ((|go| (cons '|𝐂| (vector #'|go| |Γ|))))
                  (let ((|c26| 1))
                    (let ((|pair27| (cons |c26| |_pL#n|)))
                      (let ((|_code1020| (svref (cdr |go|) 0)))
                        (let ((|Γc1021| (svref (cdr |go|) 1)))
      ...
      (let ((|c30| 5))
        (let ((|u31| nil))
          (let ((|pair32| (cons |c30| |u31|)))
            (let ((|_code1023| (svref (cdr |lam29|) 0)))
              (let ((|Γc1024| (svref (cdr |lam29|) 1)))
                (let ((|ρc1025| (cons |pair32| |Γc1024|)))
                  (funcall |_code1023| |ρc1025| |k|))))))))))
