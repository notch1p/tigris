                                                                                                  ...
                                                                                                  (let ((|p22| (%int- |_pR#acc| |c21|)))
                                                                                                    (let ((|pair23| (cons |p2| |p22|)))
                                                                                                      (let ((|ρ1001| (cons |pair23| |Γ|)))
                                                                                                        (funcall #'|go| |ρ1001| |k|)))))))
                                                                                                (funcall (the function |_code1002|) |ρc1004| #'|k11|)))))))))
                                                                                    (funcall (the function |_code1005|) |ρc1007| #'|k9|))))))))
                                                                          (funcall (the function |_code1008|) |ρc1010| #'|k7|)))))))))
                                                              (funcall (the function |_code1011|) |ρc1013| #'|k5|)))))))))
                                                  (funcall (the function |_code1014|) |ρc1016| #'|k3|))))))))
                                        (funcall (the function |_code1017|) |ρc1019| #'|k1|)))))))))))))))))))))
